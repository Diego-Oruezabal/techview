...
import { roles, difficulties } from "./FormCreateInterview.data";
  ...
  return (
      <Form {...form}>
        ...
        <FormField
            ...
            />
            <Button type="submit" className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 w-full">
                Start interview
                <Mic />
            </Button>
        </form>
